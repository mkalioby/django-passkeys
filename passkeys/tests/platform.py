...
from passkeys.util import get_current_platform
...
class PlatformTestCase(TestCase):
    ...
    def test_android(self):
        ...
        self.check_platform(
            "Mozilla/5.0 (Linux; Android 10; SM-A205U) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.5735.130 Mobile Safari/537.36",
            "Chrome Mobile / Android")
        self.check_platform(
            "Mozilla/5.0 (Linux; Android 10; LM-Q720) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.5735.130 Mobile Safari/537.36",
            "Chrome Mobile / Android")
